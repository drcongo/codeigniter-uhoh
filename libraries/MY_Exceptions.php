...
if ( ! defined('IN_PRODUCTION'))
{
    if(ENVIRONMENT !== 'development'){
        ...
        define('SYSADMIN', 'your@emailaddress.com');
        define('SERVERNAME', 'A human readable name for your server');
        define('SERVERADDRESS', 'example.com');
    }else{
...
class MY_Exceptions extends CI_Exceptions
{
    ...
    public static function exception_handler(Exception $e)
    {
        ...
        try
        {
            ...
            if (IN_PRODUCTION)
            {
                if($message !== "The page you requested was not found."){
                    ob_start();
                    echo("<h2>$code - $message</h2>");
                    ...
                    ob_clean();
                    $to = SYSADMIN; 
                    $from = SERVERNAME . '<no-reply@' . SERVERADDRESS . '>'; 
                    $subject = 'Server Error, ' . SERVERNAME . ": $code - $message"; 
                    $headers  = "From: $from\r\n"; 
